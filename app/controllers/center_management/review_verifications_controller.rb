class CenterManagement::ReviewVerificationsController < CenterManagement::BaseController
  before_action :review_verification, :authorize_verification, only: :update

  def index
    branches = current_user.managed_center.branches
  ...
  def update
    ...
    redirect_back fallback_location: center_management_review_verifications_path
  end
